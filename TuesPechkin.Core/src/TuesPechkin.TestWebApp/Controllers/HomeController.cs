...
namespace TuesPechkin.TestWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult PdfTest()
        {
            ...
            doc.Objects.Add(new ObjectSettings { PageUrl = "http://baidu.com " });
            //doc.Objects.Add(new ObjectSettings { HtmlText="<h1>Test</h1>" });
        ...
        public FileResult ScratchPad()
        {
            ...
            obj.PageUrl = Url.Action(new UrlActionContext {
                Action = "PostAnything",
                Controller = "Home",
